...
describe('OptionsBuilder', function() {
  ...
  it('add addSecuritySchemeOAuth2Implicit', function() {
    expect(
      sut.buildOptions().addSecuritySchemeOAuth2Implicit('oaImplicit7', 'http://my.app/authorize', {
        scope1: 'my scope 1',
        scope2: 'my scope 2'
      })
    ).eql({
  ...
  it('add addSecuritySchemeOAuth2AuthCode', function() {
    expect(
      sut
        .buildOptions()
        .addSecuritySchemeOAuth2AuthCode('ac5', 'http://my.app/authorize', 'http://my.app/token', {
          scope1: 'my scope 1',
          scope2: 'my scope 2'
        })
    ).eql({
